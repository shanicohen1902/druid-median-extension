...
public class MedianAggregatorFactory extends AggregatorFactory
{
  ...
  // Type name for JSON.
  public static final String TYPE_NAME = "median";
  ...
  @JsonCreator
  public MedianAggregatorFactory(
  ...
  {
    return new MedianAggregator(metricFactory.makeColumnValueSelector(fieldName));
  }

  @Override
  public BufferAggregator factorizeBuffered(ColumnSelectorFactory metricFactory)
  {
    return new MedianBufferAggregator(metricFactory.makeColumnValueSelector(fieldName));
  }
  ...
  {
    return new MedianAggregatorFactory(name, name);
  }
  ...
  {
    return ImmutableList.of(new MedianAggregatorFactory(fieldName, fieldName));
  }
  ...
  public boolean equals(final Object o)
  {
    ...
    final MedianAggregatorFactory that = (MedianAggregatorFactory) o;
  ...
  {
    return "MedianAggregatorFactory{" +
           "name='" + name + '\'' +
           ", fieldName='" + fieldName + '\'' +
           '}';
  }
